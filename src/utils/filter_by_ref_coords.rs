...
mod tests {
    ...
    fn ranges_filter_panics_when_start_greater_than_end() {
        ...
        let mut ranges = Ranges {
            starts: vec![Some(10), Some(30)],
            ends: vec![Some(15), Some(25)], // 30 > 25, this should panic
            lengths: vec![Some(5), Some(5)],
            qual: vec![100, 120],
            reference_starts: vec![Some(10), Some(30)],
            reference_ends: vec![Some(15), Some(25)],
    ...
    fn ranges_filter_panics_when_starts_not_increasing() {
        ...
        let mut ranges = Ranges {
            starts: vec![Some(10), Some(10)], // Same start value, should panic
            ends: vec![Some(15), Some(20)],
            lengths: vec![Some(5), Some(10)],
            qual: vec![100, 120],
            reference_starts: vec![Some(10), Some(10)],
            reference_ends: vec![Some(15), Some(20)],
            reference_lengths: vec![Some(5), Some(10)],
            seq_len: 50,
            reverse: false,
        };
    ...
    fn ranges_filter_panics_when_starts_decreasing() {
        ...
        let mut ranges = Ranges {
            starts: vec![Some(20), Some(10)], // Decreasing start values, should panic
            ends: vec![Some(25), Some(15)],
            lengths: vec![Some(5), Some(5)],
            qual: vec![100, 120],
            reference_starts: vec![Some(20), Some(10)],
            reference_ends: vec![Some(25), Some(15)],
            reference_lengths: vec![Some(5), Some(5)],
            seq_len: 50,
            reverse: false,
        };
    ...
    fn ranges_filter_panics_when_start_less_than_previous_end() {
        ...
        let mut ranges = Ranges {
            starts: vec![Some(10), Some(14)], // start (14) < previous_end (15)
            ends: vec![Some(15), Some(20)],
            lengths: vec![Some(5), Some(6)],
            qual: vec![100, 120],
            reference_starts: vec![Some(10), Some(14)],
            reference_ends: vec![Some(15), Some(20)],
            reference_lengths: vec![Some(5), Some(6)],
            seq_len: 50,
            reverse: false,
        };
